...
if __name__=="__main__":
    ...
    tensorboard = TensorBoard(log_dir="/home/estudiante/Handedness/DetectHand/logs/fit/", histogram_freq=1, write_graph=False, write_images=False)
